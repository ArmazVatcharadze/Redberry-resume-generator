...
if (location.pathname === "/Redberry-resume-generator/personalinfo.html") {
  //   FIRST INFO INPUTS
  ...
  textAreaInput.addEventListener("input", function () {
    const letterNum =
      textAreaOutput.textContent.replace(/[^a-zA-Z,ა-ჰ,0-9]/g).length;
    if (letterNum - 1 !== 0) {
...
} else if (location.pathname === "/Redberry-resume-generator/experiance.html") {
...
<hr class="second-hr" >`;
    ...
    jobDescription.addEventListener("input", function () {
      const descriptionNew = document.querySelector(
        `.job-deskription-user${count}`
      );
...
} else if (location.pathname === "/Redberry-resume-generator/education.html") {
...
*/
} else if (location.pathname === "/Redberry-resume-generator/result.html") {
  const aboutHeader = document.querySelector(".about-header");
  const resMailLogo = document.querySelector(".res-mail-logo");
  const resNumberLogo = document.querySelector(".res-number-logo");
  const userImage = document.querySelector(".user-image");
